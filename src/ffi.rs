...
pub type Struct_cpVect = ::Pnt2;
pub type Struct_cpMat2x2 = ::Mat2;
pub type Struct_cpTransform = ::Iso2; 
pub type Struct_cpBB = ::BB;
pub type Struct_cpContactPointSet = ::ContactPointSet;
...
extern "C" {
    ...
    pub fn cpfmax(a: cpFloat, b: cpFloat) -> cpFloat;
    pub fn cpfmin(a: cpFloat, b: cpFloat) -> cpFloat;
    pub fn cpfabs(f: cpFloat) -> cpFloat;
    pub fn cpfclamp(f: cpFloat, min: cpFloat, max: cpFloat) -> cpFloat;
    pub fn cpfclamp01(f: cpFloat) -> cpFloat;
    pub fn cpflerp(f1: cpFloat, f2: cpFloat, t: cpFloat) -> cpFloat;
    pub fn cpflerpconst(f1: cpFloat, f2: cpFloat, d: cpFloat) -> cpFloat;
    ...
    pub fn cpvlerpconst(v1: cpVect, v2: cpVect, d: cpFloat) -> cpVect;
    ...
    pub fn cpMat2x2New(a: cpFloat, b: cpFloat, c: cpFloat, d: cpFloat)
     -> cpMat2x2;
    pub fn cpMat2x2Transform(m: cpMat2x2, v: cpVect) -> cpVect;
    ...
    pub fn cpBBCenter(bb: cpBB) -> cpVect;
    pub fn cpBBArea(bb: cpBB) -> cpFloat;
    pub fn cpBBMergedArea(a: cpBB, b: cpBB) -> cpFloat;
    pub fn cpBBSegmentQuery(bb: cpBB, a: cpVect, b: cpVect) -> cpFloat;
    pub fn cpBBIntersectsSegment(bb: cpBB, a: cpVect, b: cpVect) -> cpBool;
    ...
    pub fn cpTransformNew(a: cpFloat, b: cpFloat, c: cpFloat, d: cpFloat,
                          tx: cpFloat, ty: cpFloat) -> cpTransform;
    pub fn cpTransformNewTranspose(a: cpFloat, c: cpFloat, tx: cpFloat,
                                   b: cpFloat, d: cpFloat, ty: cpFloat)
     -> cpTransform;
    pub fn cpTransformInverse(t: cpTransform) -> cpTransform;
    pub fn cpTransformMult(t1: cpTransform, t2: cpTransform) -> cpTransform;
    pub fn cpTransformPoint(t: cpTransform, p: cpVect) -> cpVect;
    pub fn cpTransformVect(t: cpTransform, v: cpVect) -> cpVect;
    pub fn cpTransformbBB(t: cpTransform, bb: cpBB) -> cpBB;
    pub fn cpTransformTranslate(translate: cpVect) -> cpTransform;
    pub fn cpTransformScale(scaleX: cpFloat, scaleY: cpFloat) -> cpTransform;
    pub fn cpTransformRotate(radians: cpFloat) -> cpTransform;
    pub fn cpTransformRigid(translate: cpVect, radians: cpFloat)
     -> cpTransform;
    pub fn cpTransformRigidInverse(t: cpTransform) -> cpTransform;
    pub fn cpTransformWrap(outer: cpTransform, inner: cpTransform)
     -> cpTransform;
    pub fn cpTransformWrapInverse(outer: cpTransform, inner: cpTransform)
     -> cpTransform;
    pub fn cpTransformOrtho(bb: cpBB) -> cpTransform;
    pub fn cpTransformBoneScale(v0: cpVect, v1: cpVect) -> cpTransform;
    pub fn cpTransformAxialScale(axis: cpVect, pivot: cpVect, scale: cpFloat)
     -> cpTransform;
    ...
    pub fn cpSpatialIndexCollideStatic(dynamicIndex: *mut cpSpatialIndex,
                                       ...
                                       func: cpSpatialIndexQueryFunc,
                                       data: *mut ::libc::c_void);
    pub fn cpSpatialIndexDestroy(index: *mut cpSpatialIndex);
    pub fn cpSpatialIndexCount(index: *mut cpSpatialIndex) -> ::libc::c_int;
    pub fn cpSpatialIndexEach(index: *mut cpSpatialIndex,
                              func: cpSpatialIndexIteratorFunc,
                              data: *mut ::libc::c_void);
    pub fn cpSpatialIndexContains(index: *mut cpSpatialIndex,
                                  obj: *mut ::libc::c_void,
                                  hashid: cpHashValue) -> cpBool;
    pub fn cpSpatialIndexInsert(index: *mut cpSpatialIndex,
                                obj: *mut ::libc::c_void,
                                hashid: cpHashValue);
    pub fn cpSpatialIndexRemove(index: *mut cpSpatialIndex,
                                obj: *mut ::libc::c_void,
                                hashid: cpHashValue);
    pub fn cpSpatialIndexReindex(index: *mut cpSpatialIndex);
    pub fn cpSpatialIndexReindexObject(index: *mut cpSpatialIndex,
                                       obj: *mut ::libc::c_void,
                                       hashid: cpHashValue);
    pub fn cpSpatialIndexQuery(index: *mut cpSpatialIndex,
                               obj: *mut ::libc::c_void, bb: cpBB,
                               func: cpSpatialIndexQueryFunc,
                               data: *mut ::libc::c_void);
    pub fn cpSpatialIndexSegmentQuery(index: *mut cpSpatialIndex,
                                      obj: *mut ::libc::c_void, a: cpVect,
                                      b: cpVect, t_exit: cpFloat,
                                      func: cpSpatialIndexSegmentQueryFunc,
                                      data: *mut ::libc::c_void);
    pub fn cpSpatialIndexReindexQuery(index: *mut cpSpatialIndex,
                                      func: cpSpatialIndexQueryFunc,
                                      data: *mut ::libc::c_void);
    ...
    pub fn cpShapeFilterNew(group: cpGroup, categories: cpBitmask,
                            mask: cpBitmask) -> cpShapeFilter;
    ...
    pub fn cpSpaceAddPostStepCallback_NOKEYS(space: *mut cpSpace,
                                             func: cpPostStepFunc,
                                             data1: *mut ::libc::c_void,
                                             data2: *mut ::libc::c_void) -> cpBool;
    ...
    pub fn cpShapeUpdateFunc(shape: *mut cpShape,
